...
})(this, (function (React, ReactDOM, GaugeComponent) { 'use strict';

  function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

  var React__default = /*#__PURE__*/_interopDefaultLegacy(React);
  var ReactDOM__default = /*#__PURE__*/_interopDefaultLegacy(ReactDOM);
  var GaugeComponent__default = /*#__PURE__*/_interopDefaultLegacy(GaugeComponent);

  // Generate a random test value between 0 and 100
  const randomValue = Math.floor(Math.random() * 101);

  // Render the gauge into an element with id "myGauge"
  ReactDOM__default["default"].render( /*#__PURE__*/React__default["default"].createElement(GaugeComponent__default["default"], {
    value: randomValue,
    type: "radial",
    arc: {
